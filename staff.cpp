...
void updateOperatingHours(vector<OperatingHours>& operatingHours) {
    int choice;
    do {
        ...
        if (choice == 1) {
            ...
            operatingHours.push_back(newHours);
            ...
            if (staffLogin()) {
                ...
                do {
                    ...
                    if (staffChoice == 1) {
                        ...
                        updateOperatingHours(customOperatingHours);
